...
import 'package:flutter_application_1/Thanjavurgovernmentambulance.dart';
import 'package:flutter_application_1/Thanjavurprivateambulance.dart';
import 'package:flutter_application_1/Trichydepartment.dart';

class ThanjavurAmbulancescreen extends StatefulWidget {
  const ThanjavurAmbulancescreen({super.key});

  @override
  State<ThanjavurAmbulancescreen> createState() =>
      _ThanjavurAmbulancescreenState();
}

class _ThanjavurAmbulancescreenState extends State<ThanjavurAmbulancescreen> {
  @override
      ...
      child: TextButton.icon(
        onPressed: () {
          Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (context) =>
                      const Thanjavurgovernmentambulancescreen()));
        },
        icon: Icon(
      ...
      child: TextButton.icon(
        onPressed: () {
          Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (context) =>
                      const ThanjavurprivateAmbulancescreen()));
        },
        icon: Icon(
          Icons.health_and_safety,
          size: 32,
